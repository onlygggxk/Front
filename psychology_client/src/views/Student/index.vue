    ...
    >
      ...
      >
        ...
        <el-form-item label="年龄"
                      prop="stuAge"
        >
          <el-input-number v-model="formData.stuAge" :max="1000000"></el-input-number>
        </el-form-item>
        <el-form-item label="性别"
                      prop="stuSex"
        >
          <el-radio-group v-model="formData.stuSex">
        ...
        <el-form-item label="联系方式"
                      prop="stuPhone"
        >
          <el-input v-model="formData.stuPhone"></el-input>
        </el-form-item>
        <el-form-item label="家庭住址"
                      prop="stuAddress"
        >
          <el-input v-model="formData.stuAddress"></el-input>
        </el-form-item>
        <el-form-item label="所属班级"
                      prop="stuClassNum"
        >
          <el-input v-model="formData.stuClassNum"></el-input>
        </el-form-item>
        <el-form-item label="照片"
                      prop="stuImg"
        >
          <uploadImg v-model="formData.stuImg"></uploadImg>
        </el-form-item>
