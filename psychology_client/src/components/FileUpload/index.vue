...
export default {
  ...
  data() {
    return {
      ...
      number: 0,
      uploadList: [],
      uploadFileUrl: process.env.VUE_APP_BASE_API + '/upload/file1', // 请求地址
      headers: { Authorization: 'Bearer ' }, // 设置上传的请求头部
      fileList: []
    }
  },
  watch: {
  ...
  methods: {
    ...
    handleUploadSuccess(res, file) {
      if (res.code === 200) {
        ...
        this.uploadedSuccessfully(file.name)
      } else {
        this.number--
        this.loading = false
